...
from .constants import (ABSENT, BHS, ELIGIBLE_FOR_CONSENT, ELIGIBLE_FOR_SCREENING, HTC, HTC_ELIGIBLE, NOT_ELIGIBLE,
...
options = list(set([ABSENT, BHS, ELIGIBLE_FOR_CONSENT, ELIGIBLE_FOR_SCREENING, HTC, HTC_ELIGIBLE, NOT_ELIGIBLE,
                    NOT_REPORTED, REFUSED, UNDECIDED, REFUSED_HTC, BHS_LOSS, ANNUAL, DECEASED]))
