    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_appt_datetime_source', models.CharField(choices=[('neighbour', 'Neighbour'), ('household member', 'Household Member'), ('hbc', 'Field RA'), ('other', 'Other')], max_length=25, verbose_name='Appointment date suggested by?')),
                ...
                ('absent_member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='member.AbsentMember')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='HistoricalAbsentMemberEntry',
            fields=[
                ('created', models.DateTimeField(default=edc_base.utils.get_utcnow, editable=False)),
                ('modified', models.DateTimeField(default=edc_base.utils.get_utcnow, editable=False)),
                ('user_created', edc_base.model.fields.userfield.UserField(blank=True, editable=False, max_length=50, verbose_name='user created')),
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_id', edc_base.model.fields.uuid_auto_field.UUIDAutoField(primary_key=True, serialize=False)),
                ('absent_member', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='member.AbsentMember')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'historical Absent Member Entry',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': 'history_date',
            },
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', django_crypto_fields.fields.firstname_field.FirstnameField(blank=True, db_index=True, help_text=' (Encryption: RSA local)', max_length=71, validators=[django.core.validators.RegexValidator('^[A-Z]{1,250}$', 'Ensure first name is only CAPS and does not contain any spaces or numbers')], verbose_name='First name')),
                ...
                ('member_status', models.CharField(choices=[('BHS', 'BHS'), ('REFUSED_HTC', 'REFUSED_HTC'), ('DECEASED', 'DECEASED'), ('ANNUAL', 'ANNUAL'), ('BHS_SCREEN', 'BHS_SCREEN'), ('HTC', 'HTC'), ('NOT_REPORTED', 'NOT_REPORTED'), ('NOT_ELIGIBLE', 'NOT_ELIGIBLE'), ('REFUSED', 'REFUSED'), ('BHS_LOSS', 'BHS_LOSS'), ('BHS_ELIGIBLE', 'BHS_ELIGIBLE'), ('HTC_ELIGIBLE', 'HTC_ELIGIBLE'), ('UNDECIDED', 'UNDECIDED'), ('ABSENT', 'ABSENT')], db_index=True, editable=False, help_text='RESEARCH, ABSENT, REFUSED, UNDECIDED', max_length=25, null=True)),
                ...
                ('history_id', edc_base.model.fields.uuid_auto_field.UUIDAutoField(primary_key=True, serialize=False)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('household_structure', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='household.HouseholdStructure')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason_other', edc_base.model.fields.custom_fields.OtherCharField(blank=True, editable=True, verbose_name='...if "Other", specify')),
                ('refused_member_status', models.CharField(default='REFUSED', editable=False, help_text="Change the refusal status from 'refused' to 'no longer refusing' if and when the subject changes their mind", max_length=100, verbose_name='Refusal status')),
        ...
        migrations.CreateModel(
            name='HistoricalUndecidedMemberEntry',
            fields=[
                ('created', models.DateTimeField(default=edc_base.utils.get_utcnow, editable=False)),
                ('modified', models.DateTimeField(default=edc_base.utils.get_utcnow, editable=False)),
                ('user_created', edc_base.model.fields.userfield.UserField(blank=True, editable=False, max_length=50, verbose_name='user created')),
                ...
                ('comment', django_crypto_fields.fields.encrypted_text_field.EncryptedTextField(blank=True, help_text='IMPORTANT: Do not include any names or other personally identifying information in this comment (Encryption: AES local)', max_length=250, null=True, verbose_name='Comments')),
                ('report_datetime', models.DateTimeField(validators=[edc_base.model.validators.date.datetime_not_future], verbose_name='Report date')),
                ('reason', models.CharField(choices=[('afraid_to_test', 'afraid_to_test'), ('not ready to test', 'not ready to test'), ('wishes to test with partner', 'wishes to test with partner'), ('OTHER', 'Other...')], max_length=100, verbose_name='Reason')),
                ('history_date', models.DateTimeField()),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_id', edc_base.model.fields.uuid_auto_field.UUIDAutoField(primary_key=True, serialize=False)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
            ...
            options={
                'verbose_name': 'historical Undecided Member Entry',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': 'history_date',
            },
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personal_details_changed', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], default='-', help_text='personal details (name/surname)', max_length=10, null=True, verbose_name='Have your personal details (name/surname) changed since the last time we visited you?')),
                ('details_change_reason', models.CharField(blank=True, choices=[('married', 'Married'), ('parent_married', 'Parent Married')], default='-', help_text='if personal detail changed choice a reason above.', max_length=30, null=True, verbose_name='If YES, please specify the reason')),
                ('household_structure', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='household.HouseholdStructure')),
            ],
            options={
                'ordering': ['-created'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referral_clinic', models.CharField(blank=True, help_text='Required if subject was referred', max_length=25, null=True, verbose_name='If referred, which clinic')),
                ('comment', models.TextField(blank=True, max_length=250, null=True)),
                ('household_member', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='member.HouseholdMember')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_filled', models.BooleanField(default=False, editable=False, help_text='This form is autofilled for non-BHS surveys using information from amember consented in a previous survey. See HouseholdMemberHelper')),
                ('auto_fill_member_id', models.CharField(editable=False, help_text='pk of household member used to autofill', max_length=50, null=True)),
                ('household_structure', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='household.HouseholdStructure')),
            ],
        ),
        migrations.CreateModel(
            name='TransportMode',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(validators=[edc_base.model.validators.date.datetime_not_future], verbose_name='Report date')),
                ('reason', models.CharField(choices=[('afraid_to_test', 'afraid_to_test'), ('not ready to test', 'not ready to test'), ('wishes to test with partner', 'wishes to test with partner'), ('OTHER', 'Other...')], max_length=100, verbose_name='Reason')),
                ('undecided_member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='member.UndecidedMember')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='member.HouseholdMember'),
        ),
        migrations.AddField(
            model_name='householdinfo',
            name='transport_mode',
            field=models.ManyToManyField(blank=True, help_text='Note: Please read each response to the participant and check all that apply. If participant does not want to answer, leave blank.', to='member.TransportMode', verbose_name='Does any member of this household (excluding visitors) own any of the following forms of transport in working condition? (check all that apply).'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='household_member',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='member.HouseholdMember'),
        ),
        migrations.AddField(
            model_name='historicalundecidedmemberentry',
            name='undecided_member',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='member.UndecidedMember'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='historicalhtcmemberhistory',
            name='survey',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='survey.Survey'),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='undecidedmemberentry',
            unique_together=set([('undecided_member', 'report_datetime')]),
        ),
        migrations.AlterUniqueTogether(
            name='memberappointment',
        ...
        migrations.AlterUniqueTogether(
            name='householdmember',
            unique_together=set([('subject_identifier', 'household_structure'), ('household_structure', 'first_name', 'initials', 'additional_key')]),
        ),
        ...
        migrations.AlterUniqueTogether(
            name='householdheadeligibility',
            unique_together=set([('household_member', 'aged_over_18', 'verbal_script')]),
        ),
        migrations.AlterUniqueTogether(
            name='enrollmentchecklist',
        ...
        migrations.AlterUniqueTogether(
            name='absentmemberentry',
            unique_together=set([('absent_member', 'report_datetime')]),
        ),
    ]
